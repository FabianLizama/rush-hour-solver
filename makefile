...
main: src/main.cpp out/State.o out/Board.o out/Car.o out/Stack.o out/MinHeap.o
	g++ ${FLAGS} out/State.o out/Board.o out/Car.o src/main.cpp out/Stack.o out/MinHeap.o -o main
